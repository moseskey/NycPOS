...
// JG uniCenta June 2014 includes StockUnits
        ...
        productsRow = new Row(
            new Field("ID", Datas.STRING,
                      Formats.STRING),                                                              //0
            new Field(AppLocal.getIntString("label.prodref"), Datas.STRING, Formats.STRING, true, true,
                      true),          //1
            new Field(AppLocal.getIntString("label.prodbarcode"), Datas.STRING, Formats.STRING, false, true,
                      true),     //2
            new Field(AppLocal.getIntString("label.prodname"), Datas.STRING, Formats.STRING, true, true,
                      true),         //3
            new Field("ISCOM", Datas.BOOLEAN,
                      Formats.BOOLEAN),                                                         //4
            new Field("ISSCALE", Datas.BOOLEAN,
                      Formats.BOOLEAN),                                                       //5
            ...
            new Field(AppLocal.getIntString("label.prodcategory"), Datas.STRING, Formats.STRING, false, false,
                      true),   //8
            new Field(AppLocal.getIntString("label.taxcategory"), Datas.STRING, Formats.STRING, false, false,
                      true),    //9
            new Field(AppLocal.getIntString("label.attributeset"), Datas.STRING, Formats.STRING, false, false,
                      true),   //10
            new Field("IMAGE", Datas.IMAGE,
                      Formats.NULL),                                                              //11
            new Field("STOCKCOST", Datas.DOUBLE,
                      Formats.CURRENCY),                                                     //12
            new Field("STOCKVOLUME", Datas.DOUBLE,
                      Formats.DOUBLE),                                                     //13
            new Field("ISCATALOG", Datas.BOOLEAN,
                      Formats.BOOLEAN),                                                     //14
            new Field("CATORDER", Datas.INT,
                      Formats.INT),                                                              //15
            new Field("PROPERTIES", Datas.BYTES,
                      Formats.NULL),                                                         //16

// Added JG 20.12.10 - Kitchen Print + 25.06.11 - ISService
            new Field("ISKITCHEN", Datas.BOOLEAN,
                      Formats.BOOLEAN),                                                     //17
            new Field("ISSERVICE", Datas.BOOLEAN,
                      Formats.BOOLEAN),                                                     //18
// Added JG 13 NOV 12 - DISPLAY for HTML text rendering
            new Field(AppLocal.getIntString("label.display"), Datas.STRING, Formats.STRING, false, true,
                      true),         //19
// **
// ADDED JDL 19.12.12 - Varible Price Product, mandatory attributes, text tip message
            new Field("ISVPRICE", Datas.BOOLEAN,
                      Formats.BOOLEAN),                                                      //20
            new Field("ISVERPATRIB", Datas.BOOLEAN,
                      Formats.BOOLEAN),                                                   //21
            new Field("TEXTTIP", Datas.STRING,
                      Formats.STRING),                                                         //22
// ADDED JDL 25.05.13 Warranty flag
            new Field("WARRANTY", Datas.BOOLEAN,
                      Formats.BOOLEAN),                                                      //23
//  JG July 2014
            new Field(AppLocal.getIntString("label.stockunits"), Datas.DOUBLE,
                      Formats.DOUBLE)                          //24
...
// JG 22 Oct 13 - CCard Name
    ...
    public final void deleteTicket(final TicketInfo ticket,
                                   final String location) throws BasicException {
...
// ADDED JG 03.07.11 Payment Notes
    ...
    public final SentenceExec getCatalogCategoryAdd() {
        return new StaticSentence(s,
                                  "INSERT INTO PRODUCTS_CAT(PRODUCT, CATORDER) SELECT ID, " + s.DB.INTEGER_NULL() +
