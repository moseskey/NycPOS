...
public class PaymentInfoMagcardRefund extends PaymentInfoMagcard {
    ...
    public PaymentInfoMagcardRefund(String sHolderName, String sCardNumber, String sExpirationDate,
                                    String track1, String track2, String track3, String sTransactionID, double dTotal) {
