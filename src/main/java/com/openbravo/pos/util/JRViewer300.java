...
public final class JRViewer300 extends javax.swing.JPanel implements JRHyperlinkListener {
    ...
    public JRViewer300(String fileName, boolean isXML, Locale locale,
    ...
    public JRViewer300(InputStream is, boolean isXML, Locale locale,
                       ResourceBundle resBundle) throws JRException {
        initResources(locale, resBundle);
    ...
    public JRSaveContributor[] getSaveContributors() {
        return (JRSaveContributor[])saveContributors.toArray(new
                                                             JRSaveContributor[saveContributors.size()]);
    }
    ...
    public JRHyperlinkListener[] getHyperlinkListeners() {
        return (JRHyperlinkListener[])hyperlinkListeners.toArray(new
                                                                 JRHyperlinkListener[hyperlinkListeners.size()]);
    }
...
// JG Jul 2012 Added Docx Contributor
        ...
        switch (hyperlink.getHyperlinkTypeValue()) {
            ...
            case LOCAL_ANCHOR : {
                    if (hyperlink.getHyperlinkAnchor() != null) {
                        ...
                        JRPrintAnchorIndex anchorIndex = (JRPrintAnchorIndex)anchorIndexes.get(
    ...
    private void initComponents() {
        ...
        btnPrint.setIcon(new javax.swing.ImageIcon(
                             getClass().getResource("/images/yast_printer.png"))); // NOI18N
        ...
        btnActualSize.setIcon(new javax.swing.ImageIcon(
                                  getClass().getResource("/images/mime.png"))); // NOI18N
        ...
        btnFitPage.setIcon(new javax.swing.ImageIcon(
                               getClass().getResource("/images/mime2.png"))); // NOI18N
        ...
        btnFitWidth.setIcon(new javax.swing.ImageIcon(
                                getClass().getResource("/images/mime3.png"))); // NOI18N
        ...
        btnNext.setIcon(new javax.swing.ImageIcon(
        ...
        btnLast.setIcon(new javax.swing.ImageIcon(
    ...
    void txtGoToActionPerformed(java.awt.event.ActionEvent
                                evt) {//GEN-FIRST:event_txtGoToActionPerformed
        try {
    ...
    void cmbZoomItemStateChanged(java.awt.event.ItemEvent
                                 evt) {//GEN-FIRST:event_cmbZoomItemStateChanged
    ...
    void pnlMainComponentResized(java.awt.event.ComponentEvent
                                 evt) {//GEN-FIRST:event_pnlMainComponentResized
        // Add your handling code here:
    ...
    void btnActualSizeActionPerformed(java.awt.event.ActionEvent
                                      evt) {//GEN-FIRST:event_btnActualSizeActionPerformed
        // Add your handling code here:
    ...
    void btnFitWidthActionPerformed(java.awt.event.ActionEvent
                                    evt) {//GEN-FIRST:event_btnFitWidthActionPerformed
        // Add your handling code here:
    ...
    void btnFitPageActionPerformed(java.awt.event.ActionEvent
                                   evt) {//GEN-FIRST:event_btnFitPageActionPerformed
        // Add your handling code here:
        if (btnFitPage.isSelected()) {
            btnActualSize.setSelected(false);
            btnFitWidth.setSelected(false);
    ...
    void btnPrintActionPerformed(java.awt.event.ActionEvent
                                 evt) { //GEN-FIRST:event_btnPrintActionPerformed
    ...
    void btnLastActionPerformed(java.awt.event.ActionEvent
                                evt) { //GEN-FIRST:event_btnLastActionPerformed
    ...
    void btnNextActionPerformed(java.awt.event.ActionEvent
                                evt) { //GEN-FIRST:event_btnNextActionPerformed
    ...
    void btnPreviousActionPerformed(java.awt.event.ActionEvent
                                    evt) { //GEN-FIRST:event_btnPreviousActionPerformed
    ...
    void btnFirstActionPerformed(java.awt.event.ActionEvent
                                 evt) { //GEN-FIRST:event_btnFirstActionPerformed
    ...
    void btnReloadActionPerformed(java.awt.event.ActionEvent
                                  evt) { //GEN-FIRST:event_btnReloadActionPerformed
    ...
    void btnZoomInActionPerformed(java.awt.event.ActionEvent
                                  evt) { //GEN-FIRST:event_btnZoomInActionPerformed
    ...
    void btnZoomOutActionPerformed(java.awt.event.ActionEvent
                                   evt) { //GEN-FIRST:event_btnZoomOutActionPerformed
    ...
    void cmbZoomActionPerformed(java.awt.event.ActionEvent
                                evt) { //GEN-FIRST:event_cmbZoomActionPerformed
    ...
    */
    protected void refreshPage() {
        ...
        Dimension dim = new Dimension(
            (int)(jasperPrint.getPageWidth() * realZoom) +
            8, // 2 from border, 5 from shadow and 1 extra pixel for image
        ...
        if (pageError) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this,
                                              java.util.ResourceBundle.getBundle("net/sf/jasperreports/view/viewer").getString("error.displaying"));
            }
        }
    ...
    protected class ImageMapPanel extends JPanel implements MouseListener, MouseMotionListener {
        ...
        protected JRPrintImageAreaHyperlink getImageMapArea(int x, int y) {
            ...
            if (imageAreaHyperlinks != null) {
                for (ListIterator it = imageAreaHyperlinks.listIterator(imageAreaHyperlinks.size());
                     image == null && it.hasPrevious();) {
