...
public class TicketLineInfo1 implements SerializableWrite, SerializableRead, Serializable {
    ...
    public TicketLineInfo1(String productid, String productname, String producttaxcategory,
    ...
    public TicketLineInfo1(String productname, String producttaxcategory, double dMultiply,
    ...
    public TicketLineInfo1(ProductInfoExt product, double dMultiply, double dPrice, TaxInfo tax,
...
//
    ...
    private void init(String productid, String attsetinstid, double dMultiply, double dPrice,
                      TaxInfo tax, Properties attributes) {
