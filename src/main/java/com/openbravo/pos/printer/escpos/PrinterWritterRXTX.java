        ...
        try {
            if (m_out == null) {
                ...
                if (m_PortIdPrinter.getPortType() == CommPortIdentifier.PORT_SERIAL) {
                    ...
                    ((SerialPort)m_CommPortPrinter).setFlowControlMode(
                        SerialPort.FLOWCONTROL_RTSCTS_IN);  // this line prevents the printer tmu220 to stop printing after +-18 lines printed
